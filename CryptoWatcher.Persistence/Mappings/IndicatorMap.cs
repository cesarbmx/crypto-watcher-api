    ...
    public class IndicatorMap
    {
        public IndicatorMap(EntityTypeBuilder<Indicator> entityBuilder)
        {
            ...
            entityBuilder.HasData(
                new Indicator(IndicatorType.CurrencyIndicator, "price", "master", "Price", "", "", null),
                new Indicator(IndicatorType.CurrencyIndicator, "price-change-24hrs", "master", "Price change 24Hrs", "", "", null),
                new Indicator(IndicatorType.CurrencyIndicator, "hype", "master", "Hype", "", "", null)
            );
        }
    }
}
